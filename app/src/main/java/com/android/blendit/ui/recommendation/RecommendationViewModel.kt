...
class RecommendationViewModel(accountPreference: AccountPreference) : ViewModel() {
    ...
    private val _favoriteResponse = MutableLiveData<com.android.blendit.remote.Result<FavoriteResponse>>()
    val favoriteResponse: LiveData<com.android.blendit.remote.Result<FavoriteResponse>> = _favoriteResponse
